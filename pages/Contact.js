            ...
            >
              ...
              <div className="sm:col-span-2">
                ...
                <textarea
                  id="message"
                  rows="6"
                  className="block p-2.5 w-full text-sm text-stone-900 bg-stone-50 rounded-lg shadow-sm border border-stone-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-stone-700 dark:border-stone-600 dark:placeholder-stone-100 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                  name="Message"
