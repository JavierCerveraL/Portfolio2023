      ...
      <section className="flex gap-6 w-full bg-slate-900 " id="projects">
        ...
        <div className="py-8 lg:py-6 px-4 md:px-28 mx-auto max-w-screen-md">
          ...
          <div className="big-box  flex gap-12 flex-wrap  ">
            ...
            <div className="grid md:grid-flow-col  bg-slate-200 animate__animated animate__fadeIn opacity-3 mt-5 rounded-xl  w-60  lg:w-auto ">
              <Link
